...
watershed.number <- "03574500"           #** You need to put it in quotes (e.g. "03574500")

# read in data
MOPEX.data <- read.csv(paste("ftp://hydrology.nws.noaa.gov/pub/gcip/mopex/US_Data/Us_438_Daily/",watershed.number,".dly",sep=""), header=FALSE)
...
site.lat.dd <-                 # enter value here for latitude in decimal degreess from Table S1 that correspond to your watershed code
site.long.dd <-                # enter value here for longitude in decimal degreess from Table S1 that correspond to your watershed code
site.area.km2 <-               # enter value here for area in square km from Table S1 that correspond to your watershed code
...
# Calculate annual values for the following:
# (1)	Streamflow (Q);
